...
public class DlgDirecciones extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Agregar nueva dirección");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgDirecciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgDirecciones dialog = new DlgDirecciones(new javax.swing.JFrame(), true);
