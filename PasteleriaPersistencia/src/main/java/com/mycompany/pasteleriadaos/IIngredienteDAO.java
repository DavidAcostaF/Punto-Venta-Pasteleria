 ...
 * <p>
 * Esta interfaz define los métodos para realizar operaciones CRUD (Crear, 
 * Leer, Actualizar, Eliminar) y consultas especializadas sobre los ingredientes
 * en la base de datos.
 * </p>
 * 
 * <p>Proporciona métodos para agregar, actualizar, eliminar y consultar 
 * ingredientes, así como para realizar consultas específicas relacionadas 
 * con el inventario de ingredientes.</p>
 * 
 * @see Ingrediente
...
public interface IIngredienteDAO {
     ...
     * 
     * @param ingrediente El objeto IngredienteMapeo que contiene los criterios de búsqueda.
     ...
     * 
     * @param ingredientesNombres Una lista de nombres de los ingredientes a consultar.
     * @return Una lista de objetos Ingrediente con las cantidades disponibles en el inventario.
     * @throws PersistenciaException Si ocurre un error durante la operación de persistencia.
     */
