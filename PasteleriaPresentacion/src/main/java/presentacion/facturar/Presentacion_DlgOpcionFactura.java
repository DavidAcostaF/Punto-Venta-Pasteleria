...
public class Presentacion_DlgOpcionFactura extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Presentacion_DlgOpcionFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Presentacion_DlgOpcionFactura dialog = new Presentacion_DlgOpcionFactura(new javax.swing.JFrame(), true);
